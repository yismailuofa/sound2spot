...
auth_manager = SpotifyOAuth(
    client_id=os.getenv("SPOTIFY_CLIENT_ID"),  # Change this to your own
...
assert URL is not None, "Please provide a URL"
...
# Create the playlist
playlist = sp.user_playlist_create(user_id, title, public=True, description="")
